...
public class TestFifoQueue {
	...
	@Test
	public final void testHasNextElements() {
		myIntQueue.offer(1);
		myIntQueue.offer(2);
		myIntQueue.offer(3);
		...
		assertTrue("Iterator returns true value", sum == 6);
	}

	@Test
	public final void testNextEmpty() {
		try {
			Iterator itr = myIntQueue.iterator();
			itr.next();
			fail("loser");
	...
	@Test
	public final void testHasNextEmpty(){
		Iterator<Integer> itr = myIntQueue.iterator();
		assertEquals("Iterator returns empty",false, itr.hasNext());
	}
