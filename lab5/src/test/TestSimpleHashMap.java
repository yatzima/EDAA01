...
public class TestSimpleHashMap {
	...
	public final void testGet() {
		...
		assertEquals("key not found in map: 1", new Integer(1), m16.get(1)); // last
																				// or
																				// first
		...
		assertEquals("key not found in map: 49", new Integer(49), m16.get(49)); // first
																				// or
																				// last
	}
	...
	public final void testRemove() {
		...
		assertEquals("wrong result from remove: 1", new Integer(65), m16.remove(65)); // first
																						// or
																						// last
		assertEquals("wrong result from remove: 1", new Integer(1), m16.remove(1)); // last
																					// or
																					// first
	...
	public final void testRemoveNonExistingElements() {
		...
		assertNull("wrong result from remove: 49", m16.remove(49)); // non-existing
																	// element
																	// in
																	// non-empty
																	// list
		assertEquals("wrong size():", 3, m16.size());
		assertNull("wrong result from remove: 2", m16.remove(2)); // non-existing
																	// element
																	// in empty
																	// list
		assertEquals("wrong size():", 3, m16.size());
	...
	public final void testStringKeys() {
		...
		// Uses new String to make sure that target keys are different objects
		// than those in the map.
